          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                ...
                contribute my skills and continue growing as a developer. If you
              ...
              <div className="flex space-x-4">
                {socialLinks.map((link, index) => (
                  <a
                    ...
                    className="p-3 bg-gray-100 rounded-full text-gray-600 hover:bg-primary-100 hover:text-primary-600 transition-all duration-200 hover:scale-110"
            ...
            <div className="pt-6 border-t border-gray-200">
              <a
                href={`/portfolio/Olena_Shereiko_Full_Stack_Developer_CV.pdf`}
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M12 10v6m0 0l-4-4m4 4l4-4m-4-4V4m0 0a2 2 0 00-2-2H7a2 2 0 00-2 2v16a2 2 0 002 2h10a2 2 0 002-2V4a2 2 0 00-2-2h-3z"
                  />
                </svg>
                Download Resume (PDF)
              </a>
